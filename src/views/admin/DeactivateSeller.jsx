                    ...
                    <table className="w-full text-sm text-left text-[#d0d2d6]">
                        <thead className="text-sm text-[#d0d2d6] uppercase border-b border-slate-700">
                            <tr>
                                ...
                                <th scope="col" className="py-3 px-4">ShopName</th>
                        ...
                        <tbody>
                            {sellers.map((d, i) => (
                                <tr key={i}>
                                    ...
                                    <td scope="row" className="py-1 px-4 font-medium whitespace-normal"><span>{ d.payment }</span> </td>
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{ d.email } </td>
                                    <td scope="row" className="py-1 px-4 font-medium whitespace-normal">{ d.status }</td>
