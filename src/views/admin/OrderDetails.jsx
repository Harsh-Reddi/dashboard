           ...
           <div className='w-full p-4 bg-[#527e2f] rounded-md '>
                ...
                <div className='p-4'>
                    ...
                    <div className='flex flex-wrap'>
                        <div className='w-[30%]'>
                            <div className='pr-3 text-[#d0d2d6] text-lg'>
                                <div className='flex flex-col gap-1'>
                                    <h2 className='pb-2 font-semibold'>Deliver To : Rahul Dravid</h2>
                                    <p><span className='text-sm'>191-103 Integer Rd., Corona, New Mexico</span></p>
                                </div>
                        ...
                        <div className='w-[70%]'>
                            <div className='pl-3'>
                                <div className='mt-4 flex flex-col bg-[#69a137] rounded-md p-4'>
