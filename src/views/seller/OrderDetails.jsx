        ...
        <div className='px-2 lg:px-7 pt-5'>
           <div className='w-full p-4 bg-[#527e2f] rounded-md '>
                <div className='flex justify-between items-center p-4'>
                    ...
                    <select 
                    onChange={status_update} value={status}
                    className='px-4 py-2 focus:border-[#2e351f] outline-none bg-[#7caa56] border border-slate-700 rounded-md text-[#d0d2d6] ' 
                    name="" 
                    id="">
                    ...
                    <div className='flex flex-wrap'>
                        <div className='w-[30%]'>
                            <div className='pr-3 text-[#d0d2d6] text-lg'>
                                ...
                                {
                                    order?.products?.map((p,i) => <div key={i} className='mt-4 flex flex-col gap-4 bg-[#7caa56] rounded-md'>
