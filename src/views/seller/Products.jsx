...
const Products = () => {
    ...
    return (
        <div className="px-2 lg:px-7 pt-5">
            <h1 className="text-lg font-semibold mb-3 text-[#19270e]">All Products</h1>
                        ...
                        <tbody>
                            {products.map((d, i) => (
                                ...
                                <td  className="py-1 px-4 font-medium whitespace-nowrap">
                                    <img className="w-[45px] h-[45px]" src={d.images[0]} alt="category_image" />
                                </td>
                                ...
                                <td className="py-1 px-4 font-medium whitespace-nowrap">{d.discount === 0 ? <span>No Discount</span> : <span>{d.discount}%</span>}</td>
